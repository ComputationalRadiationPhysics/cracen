...
Tell if buffer is empty and will stay empty. This is the case if all produces ceased to add data and no data is in the buffer. \begin{DoxyReturn}{Returns}
